...
public class Controller {
    ...
    public static User getUser(SharedPreferences sharedPreferencesLikes, SharedPreferences sharedPreferencesDisikes){
        User user = new User();
        ...
        for(int i = 0; i < ingredientIds.length; i++){
            ...
            } else if (sharedPreferencesDisikes.getBoolean(ingredientStrings[i], false)) {
    ...
    public static SubDatabase getSubDatabaseFromFirebase(){
        //Log.v("TestingGetSubDB", "method called");
